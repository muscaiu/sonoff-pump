...
class StatusChart extends Component {
  ...
  getDailyTotal = day => {
    ...
    fbStatusList &&
      fbStatusList.forEach((status, index) => {
          ...
          <Row>
            ...
            <Col sm="6">
              <ButtonGroup className="btn-group-toggle float-right" data-toggle="buttons">
                ...
                >
                  <span className="d-sm-block d-md-block d-lg-block d-xl-block">Week</span>
                </Button>
                <Button
                  color="info"
                  id="1"
                ...
                >
                  <span className="d-sm-block d-md-block d-lg-block d-xl-block">Month</span>
                </Button>
                {/* <Button
                                    color="info"
                                    id="2"
